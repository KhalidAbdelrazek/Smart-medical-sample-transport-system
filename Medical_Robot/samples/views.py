...
from .serializers import BloodSampleSerializer, SampleRequestSerializer, SamplePreviewSerializer
...
class BloodSampleDetailView(APIView):
    ...
    @extend_schema(
        ...
        parameters=[
            OpenApiParameter(name='sample_code', location=OpenApiParameter.PATH, description='Sample code or search query', required=True, type=str)
        ],
        responses={
            200: BloodSampleSerializer,
            404: OpenApiExample('Not Found', value={"success": False, "message": "No blood sample found...", "data": None})
        },
        examples=[
