...
/// Employer settings section widget with functional language and theme switches
class EmployerSettingsSection extends StatelessWidget {
  const EmployerSettingsSection({super.key});
